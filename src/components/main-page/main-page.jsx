    ...
    return <>
      ...
      <div className="container">
        <div className="header__wrapper">
          <a className="header__logo logo" href="index.html" aria-label="На главную">
    ...
    <main className="main">
      ...
      <section className="currency-converting container">
        <div className="currency-converting__wrapper">
            ...
            <form className="currency-converting__form form-convertor" action="/action_page.php" method="get">
                <div className="form-convertor__wrapper form-convertor__wrapper--process">
                    <div className="form-convertor__from">
                        <div className="form-convertor__conversion">
                            <label className="form-convertor__label" htmlFor="from-convert">У меня есть</label>
                            <input className="form-convertor__input" type="text" id="from-convert" placeholder="1000"></input>
                        </div>
                        <div className="form-convertor__selection">
                            <label className="form-convertor__label" htmlFor="currency-to-convert"></label>
                            <select className="form-convertor__select" name="currency-to-convert" id="currency-to-convert">
                    ...
                    <div className="form-convertor__to">
                        <div className="form-convertor__conversion">
                            <label className="form-convertor__label" htmlFor="to-convert">Хочу приобрести</label>
                            <input className="form-convertor__input" type="text" id="to-convert" placeholder="13,1234"></input>
                        </div>
                        <div className="form-convertor__selection">
                            <label className="form-convertor__label" htmlFor="currency-converted"></label>
                            <select className="form-convertor__select" name="currency-converted" id="currency-converted">
                ...
                <div className="form-convertor__wrapper form-convertor__wrapper--saving">
                    ...
                    <button className="button button--blue button--convertor">Сохранить результат</button>
                </div>
            </form>
            <div className="currency-converting__history history">
                    ...
                    <ul className="list history__list">
                        <li className="history__item">
                            <div className="history__wrapper">
                                <span className="history__date">25.11.2020</span>
                ...
                <button className="button button--blue button--history" type="button">Очистить историю</button>
            </div>
        </div>
      </section>
    </main>
          ...
          <div className="nav-footer">
            <ul className="list footer__nav nav-footer__list">
              <li className="nav-footer__item">
                <a className="nav-footer__link" href="#">Услуги</a>
              </li>
              <li className="nav-footer__item">
                <a className="nav-footer__link" href="#">Рассчитать кредит</a>
              </li>
              <li className="nav-footer__item">
                <a className="nav-footer__link" href="#">Контакты</a>
              </li>
              <li className="nav-footer__item">
                <a className="nav-footer__link" href="#">Задать вопрос</a>
              </li>
            </ul>
          </div>
          <div className="footer__contacts contacts-footer">
            <ul className="list contacts-footer__list">
              <li className="contacts-footer__item contacts-footer__item--mobile">
                <a className="contact__footer__link" href="tel:0904">*0904</a>
                <p className="contact__footer__description">Бесплатно для абонентов МТС, Билайн, Мегафон, Теле2</p>
              </li>
              <li className="contacts-footer__item contacts-footer__item--phone">
                <a className="contact__footer__link" href="tel:88001112233">8 800 111 22 33</a>
                <p className="contact__footer__description">Бесплатный для всех городов России</p>
              </li>
            </ul>
          </div>
          <div className="footer__social social-footer">
            <ul className="list social-footer__list">
              <li className="social-footer__item">
                <a className="social-footer__link" href="#" aria-label="facebook">
              ...
              <li className="social-footer__item">
                <a className="social-footer__link" href="#" aria-label="instagram">
              ...
              <li className="social-footer__item">
                <a className="social-footer__link" href="#" aria-label="twitter">
              ...
              <li className="social-footer__item">
                <a className="social-footer__link" href="#" aria-label="youtube">
                  <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
